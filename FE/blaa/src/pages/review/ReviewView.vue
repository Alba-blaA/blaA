        ...
        <body>
          <h2 class="h2">리뷰페이지 이용약관</h2>
            <div class="agree">
                ...
                <br>   
                이 약관은 blaA(이하 "블라"라 합니다)가 제공하는 리뷰쉐어 서비스.와 관련하여 이용 고객과 "회사"간의 권리, 의무 및 책임사항, 서비스 이용조건 및 절차 등 기본적인 사항을 규정함을 목적으로 합니다.<br>
                ...
                <b> 
                  ...
                  7. 서비스 운영을 고의로 방해하거나 서비스의 안정적 운영을 방해할 수 있는 정보 및 수신자의 명시적인 수신거부의사에 반하여 광고성 정보를 전송하는 행위 또는 (불법)스팸을 전송하는 행위<br>
                  ...
                  <b>
                    ② 회원은 회사가 제공하는 서비스 이용 시 관계법령, 이 약관의 규정, 이용안내 및 서비스상에 공지한 주의사항, 회사가 통지하는 사항 등을 준수하여야 하며, 기타 회사의 업무에 방해되는 행위를 하여서는 안됩니다. <br>
                    ③ 회원은 회사에서 공식적으로 인정한 경우를 제외하고는 서비스를 이용하여 유료서비스를 판매하거나 기타 영리 활동을 할 수 없으며 또한, 해킹, 광고, 음란사이트 홍보 또는 이를 통한 영리행위, 상용소프트웨어 불법배포 등을 할 수 없습니다. 이를 위반하여 발생한 모든 결과에 대하여 회사는 책임을 지지 않으며, 회원은 이와 같은 행위로 인하여 회사에 발생한 손해를 배상하여야 합니다. 또한, 회사는 위와 같은 사실을 발견한 경우 그와 같은 사실을 행정기관에 신고하거나 수사기관에 고발하는 등 법적조치를 취할 수 있습니다. <br>
                    ④ 회원이 서비스 이용을 위하여 고유정보를 등록하는 경우 현재의 사실과 일치하는 완전한 정보를 제공하여야 합니다(이하 본 조에서 그와 같이 등록된 정보를 “등록정보”라고 합니다). <br>
                    ⑤ 회원은 등록정보에 변경사항이 발생할 경우 즉시 갱신하여야 합니다. 회원이 제공한 등록정보 및 갱신한 등록정보가 부정확할 경우, 기타 회원이 본 조 <br>
                    ①항에 명시된 행위를 한 경우에 회사는 이 약관 제6조 에 의해 서비스 이용계약을 해지하거나 회원의 서비스 이용을 제한 또는 중지할 수 있습니다. <br>
                  </b>
                </div>               
                  <p @click="agree = !agree" style="font-size: 13px"><input :value="agree" type="checkbox" id="chk1"><label @click="agree = !agree" for="chk1">이용약관에 동의합니다 </label></p>               
